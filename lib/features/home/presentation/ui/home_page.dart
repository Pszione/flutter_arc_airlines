...
final double _defaultPadding = 20.0;
...
class _HomePageContentState extends State<_HomePageContent> {
  ...
  Widget build(BuildContext context) {
    ...
    final overflowBannerGap = bannerHeight - (_defaultPadding * 2); // TODO: error handling
      ...
      children: [
        ...
        Center(
          child: Column(
            ...
            spacing: _defaultPadding,
            children: [
              Gap(overflowBannerGap),
              _ConfirmationCodeContent(),
              _DepartureArrivalFlightDetailsContent(),
            ],
          ),
        ),
      ],
...
class _ConfirmationCodeContent extends StatelessWidget {
  const _ConfirmationCodeContent({super.key});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Card(
        surfaceTintColor: Colors.transparent,
        child: ListTile(
          title: Text('Confirmation Code', style: context.textTheme.titleMedium!.weightSemiBold()),
...
class _DepartureArrivalFlightDetailsContent extends StatelessWidget {
  const _DepartureArrivalFlightDetailsContent({super.key});
      ...
      child: Card(
        child: Column(
          ...
          children: [
            ...
            Divider(height: 0),
            Padding(
              padding: EdgeInsets.symmetric(horizontal: _defaultPadding).copyWith(top: 16.0),
              child: Row(
                      ...
                      return Column(
                        ...
                        children: [
                          Text(
                            ...
                            style:
                                context.textTheme.headlineMedium!.copyWith(height: 1).weightBold(),
                          ),
